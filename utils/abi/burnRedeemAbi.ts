export const BurnRedeemAbi = [
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint32[]', name: 'amounts', type: 'uint32[]' },
    ],
    name: 'airdrop',
    outputs: [],
  ...
  },
  {
    inputs: [
      {
        internalType: 'address[]',
        name: 'creatorContractAddresses',
        type: 'address[]',
      },
      { internalType: 'uint256[]', name: 'instanceIds', type: 'uint256[]' },
      { internalType: 'uint32[]', name: 'burnRedeemCounts', type: 'uint32[]' },
      {
        components: [
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'bool', name: 'identicalTokenURI', type: 'bool' },
    ],
